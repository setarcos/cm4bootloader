...
STMUTILDIR     = ../Utilities/STM32F4-Discovery
...
SRC += $(STMSPDSRCDIR)/stm32f4xx_fsmc.c
...
SRC += $(STMSPDSRCDIR)/stm32f4xx_iwdg.c
...
ASRC = $(APPLIBDIR)/CMSIS/Device/ST/STM32F4xx/Source/Templates/TrueSTUDIO/startup_stm32f4xx.s
...
EXTRAINCDIRS += inc
EXTRAINCDIRS += $(CMSISCOREDIR)/Device/ST/STM32F4xx/Include
EXTRAINCDIRS += $(UTILSDIR)/STM32F4-Discovery
...
OOCD_EXE=/opt/openocd/bin/openocd
# debug level
OOCD_CL=-d0
#OOCD_CL=-d3
...
# OOCD_CL+=-c"mww 0xE000ED0C 0x05fa0004" -c "sleep 1000"
# reset target
OOCD_CL+=-c "reset run"
# show the targets
OOCD_CL+=-c targets
...
THUMB    = -mthumb
THUMB_IW = -mthumb-interwork#   -mfpu=fpv4-sp-d16 -mfloat-abi=softfp
else 
THUMB    = 
THUMB_IW = 
endif
